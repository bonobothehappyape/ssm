...
/**
 * Extension of a {@link PropertyColumn} that allows property expressions that
 * do not evaluate against the given instance. In this scenario, a default value
 * will be placed in the cell instead. The user may specify this value.
 * @param <T> Model object type.
 * @author asvesdi
 */
public class FaulseExpressionTolerantPropertyColumn<T> extends
	 ...
	 */
	public FaulseExpressionTolerantPropertyColumn(IModel<String> displayModel,
	 ...
	 * @param propertyExpression property expression
	 */
	public FaulseExpressionTolerantPropertyColumn(String faultyValue,
